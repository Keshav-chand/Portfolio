...
import { RiCss3Line, RiHtml5Line, RiJavaLine, RiJavascriptLine, RiNodejsLine, RiPlaneFill, RiPlantFill, RiReactjsFill } from 'react-icons/ri'
  ...
  return (
    <div className='border-b border-neutral-800 pb-24'>
        ...
        <motion.div variants={iconVariants(4)} initial="initial" animate="animate"className='rounded-2xl border-4 border-neutral-800 p-4'>
            <RiJavaLine className='text-7xl text-blue-300 '/>
        </motion.div>
